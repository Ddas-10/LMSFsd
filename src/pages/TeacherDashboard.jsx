    ...
    return (
      <div className="flex items-center justify-center py-20">
        <div className="text-center">
          ...
          <p className="text-neutral-600 dark:text-neutral-300 font-medium">Loading dashboard...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <Card hover className="bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200">
          ...
          <div>
            <p className="text-neutral-600 dark:text-neutral-300 text-sm font-semibold mb-1">Total Courses</p>
            <p className="text-4xl font-bold text-neutral-900 dark:text-white">{courses.length}</p>
        ...
        <Card hover className="bg-gradient-to-br from-green-50 to-emerald-50 border-green-200">
          ...
          <div>
            <p className="text-neutral-600 dark:text-neutral-300 text-sm font-semibold mb-1">Total Students</p>
            <p className="text-4xl font-bold text-neutral-900 dark:text-white">{totalStudents}</p>
        ...
        <Card hover className="bg-gradient-to-br from-purple-50 to-pink-50 border-purple-200">
          ...
          <div>
            <p className="text-neutral-600 dark:text-neutral-300 text-sm font-semibold mb-1">Assignments</p>
            <p className="text-4xl font-bold text-neutral-900 dark:text-white">{totalAssignments}</p>
        ...
        <Card hover className="bg-gradient-to-br from-amber-50 to-orange-50 border-amber-200">
          ...
          <div>
            <p className="text-neutral-600 dark:text-neutral-300 text-sm font-semibold mb-1">Modules</p>
            <p className="text-4xl font-bold text-neutral-900 dark:text-white">{totalModules}</p>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {courses.length === 0 ? (
            <Card className="text-center py-16">
              ...
              <p className="text-neutral-500 dark:text-neutral-400">Start by creating your first course</p>
            </Card>
          ) : (
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between mb-2">
                        <div>
                          <h3 className="font-bold text-xl text-neutral-900 dark:text-white mb-1 group-hover:text-blue-600 transition-colors">
                            {course.title}
                          </h3>
                          <p className="text-sm text-neutral-500 dark:text-neutral-400">{course.instructor}</p>
                        </div>
                      ...
                      <div className="flex flex-wrap gap-4 text-sm">
                        ...
                        <div className="flex items-center gap-2 text-neutral-600 dark:text-neutral-300">
                          ...
                          <span className="text-neutral-500 dark:text-neutral-400">students</span>
                        </div>

                        <div className="flex items-center gap-2 text-neutral-600 dark:text-neutral-300">
                          <BookOpen size={16} />
                          <span className="font-semibold">{course.modules.length}</span>
                          <span className="text-neutral-500 dark:text-neutral-400">modules</span>
                        </div>

                        <div className="flex items-center gap-2 text-neutral-600 dark:text-neutral-300">
                          <FileText size={16} />
                          <span className="font-semibold">{course.assignments.length}</span>
                          <span className="text-neutral-500 dark:text-neutral-400">assignments</span>
                        </div>
        ...
        <div className="space-y-6">
          ...
          <Card className="bg-gradient-to-br from-red-50 to-orange-50 border-red-200">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="font-bold text-lg text-neutral-900 dark:text-white">Pending Tasks</h3>
            </div>

            <div className="space-y-3">
              <div className="p-3 bg-white rounded-xl border border-red-100">
                <p className="font-semibold text-neutral-900 dark:text-white text-sm mb-1">Grade Assignments</p>
                <p className="text-xs text-neutral-600 dark:text-neutral-400">3 submissions pending</p>
              </div>

              <div className="p-3 bg-white rounded-xl border border-orange-100">
                <p className="font-semibold text-neutral-900 dark:text-white text-sm mb-1">Course Updates</p>
                <p className="text-xs text-neutral-600 dark:text-neutral-400">2 courses need attention</p>
              </div>
            </div>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-indigo-50 to-purple-50 border-indigo-200">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-neutral-600 dark:text-neutral-300 text-sm">New Enrollments</span>
                <span className="font-bold text-neutral-900 dark:text-white text-lg">12</span>
              </div>

              <div className="flex items-center justify-between">
                <span className="text-neutral-600 dark:text-neutral-300 text-sm">Submissions</span>
                <span className="font-bold text-neutral-900 dark:text-white text-lg">28</span>
              </div>

              <div className="flex items-center justify-between">
                <span className="text-neutral-600 dark:text-neutral-300 text-sm">Avg Grade</span>
                <span className="font-bold text-neutral-900 dark:text-white text-lg">85%</span>
              </div>
            </div>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-green-50 to-emerald-50 border-green-200">
            <h3 className="font-bold text-lg text-neutral-900 dark:text-white mb-4">Course Performance</h3>

            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-neutral-600 dark:text-neutral-300 text-sm">Completion Rate</span>
                <span className="font-bold text-green-600 text-lg">78%</span>
              </div>

              <div className="flex items-center justify-between">
                <span className="text-neutral-600 dark:text-neutral-300 text-sm">Student Satisfaction</span>
                <span className="font-bold text-green-600 text-lg">4.8/5</span>
              </div>

              <div className="flex items-center justify-between">
                <span className="text-neutral-600 dark:text-neutral-300 text-sm">Active Students</span>
